...
{
  quartus-prime-pro = {
    # Full Quartus Prime Pro installation: ships the synthesis, fitter and
    # assembler toolchain.
    hasCompiler = true;
    sources = [
      {
  ...
  quartus-pro-programmer = {
    # Device programmer only. It ships no synthesis toolchain, so anything
    # that needs to compile a design cannot use it.
    hasCompiler = false;
    sources = [
      {
        version = "26.1-110";
  ...
  quartus-prime-standard = {
    # Full Quartus Prime Standard installation.
    hasCompiler = true;
    sources = [
      {
        version = "24.1";
  ...
  quartus-prime-lite = {
    # Full Quartus Prime Lite installation.
    hasCompiler = true;
    sources = [
      {
        version = "24.1";
